...
<div class="card">
        ...
        <div class="card-body card-block">
            <form method="post" action="/registeragent">
                ...
                {{ csrf_field() }}
            <div class="form-group"><label for="first_name" class=" form-control-label"></label><input name="fname" type="text" id="company" placeholder="Enter first name" value="{{$data[0]->name}}" required class="form-control"></div>
            <div class="form-group"><label for="company" value="{{$data[0]->name}}" class=" form-control-label"></label><input name="lname" type="text" id="company" placeholder="Enter last name" required class="form-control"></div>
            <div class="form-group"><label for="city" class=" form-control-label"></label><input name="telephone" type="text" id="number" placeholder="Enter a telephone number" required class="form-control" minlength="10"></div>
                        <div class="row form-group">
                                <div class="col-8">
                                    <div class="form-group"><label for="postal-code" class=" form-control-label"></label><input name="district" type="text" id="" value="{{$data[0]->district}}" placeholder="District Name" required class="form-control"></div>
